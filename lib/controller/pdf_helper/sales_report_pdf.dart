...
class SalesReportPDF{
  ...
  static Future<void> generateSalesPDFReport(List<SalesModel> dataList)async{
    ...
    for(var element in dataList){
      if(element.totalPrice!=null){
        totalAmount = totalAmount+double.parse(element.totalPrice.toString());
      }
      if(element.paymentAmount!=null){
        totalPaidAmount = totalPaidAmount+double.parse(element.paymentAmount.toString());
      }
      if(element.due!=null){
        totalDueAmount = totalDueAmount+double.parse(element.due.toString());
      }
    }
        ...
        pw.MultiPage(
            ...
            build: (pw.Context context){
              return[
                ...
                ///Title
                pw.Center(child: pw.Text('Sales History | Tashfia Export',style: boldTextStyle.copyWith(fontSize: 11.0))),
                ...
                pw.Container(
                  ...
                  child: pw.Row(
                      children: [
                        ...
                        pw.Expanded(
                          child: pw.Padding(
                            child: pw.Text('Customer ID',style: boldTextStyle.copyWith(color: PdfColors.white),textAlign: pw.TextAlign.center),
                            padding: const pw.EdgeInsets.all(3),
                          ),
                        ),
                        pw.Expanded(
                        ...
                        pw.Expanded(
                          child: pw.Padding(
                            child: pw.Text('Sales Code',style: boldTextStyle.copyWith(color: PdfColors.white),textAlign: pw.TextAlign.center),
                            padding: const pw.EdgeInsets.all(3),
                          ),
                        ),
                        pw.Expanded(
                          child: pw.Padding(
                            child: pw.Text('Paid Amount',style: boldTextStyle.copyWith(color: PdfColors.white),textAlign: pw.TextAlign.center),
                            padding: const pw.EdgeInsets.all(3),
                          ),
                        ),
                        pw.Expanded(
                        ...
                        pw.Expanded(
                          child: pw.Padding(
                            child: pw.Text('Total Amount',style: boldTextStyle.copyWith(color: PdfColors.white),textAlign: pw.TextAlign.center),
                            padding: const pw.EdgeInsets.all(3),
                          ),
                        )
                      ]
                  ...
                  itemBuilder: (context, index){
                    return pw.Row(
                        children: [
                          ...
                          pw.Container(
                            child: pw.Text('${dataList[index].customerId!}',style: normalTextStyle,textAlign: pw.TextAlign.center),
                            padding: const pw.EdgeInsets.all(3),
                            width: 45.0,
                            alignment: pw.Alignment.center,
                          ),
                          ...
                          pw.Expanded(
                            child: pw.Container(
                              child: pw.Text(DateFormat('dd-MM-yy').format(dataList[index].updatedAt!),style: normalTextStyle,textAlign: pw.TextAlign.center),
                              padding: const pw.EdgeInsets.all(3),
                              alignment: pw.Alignment.center,
                            ),
                          ),
                          pw.Expanded(
                            child: pw.Container(
                              child: pw.Text(dataList[index].salesCode!,style: normalTextStyle,textAlign: pw.TextAlign.center),
                              padding: const pw.EdgeInsets.all(3),
                              alignment: pw.Alignment.center,
                            ),
                          ),
                          ...
                          pw.Expanded(
                            child: pw.Container(
                              child: pw.Text(dataList[index].totalPrice!,style: normalTextStyle,textAlign: pw.TextAlign.center),
                              padding: const pw.EdgeInsets.all(3),
                              alignment: pw.Alignment.center,
                            ),
                          ),
                ...
                pw.Row(
                    children: [
                      ...
                      pw.Expanded(
                        child: pw.Container(
                          child: pw.Text('${double.parse((totalPaidAmount).toStringAsFixed(2))} TK',style: boldTextStyle.copyWith(color: PdfColors.purple)),
                          padding: const pw.EdgeInsets.all(3),
                          alignment: pw.Alignment.center,
                        ),
                      ),
                      pw.Expanded(
                        child: pw.Container(
                          child: pw.Text('${double.parse((totalDueAmount).toStringAsFixed(2))} TK',style: boldTextStyle.copyWith(color: PdfColors.purple)),
                          padding: const pw.EdgeInsets.all(3),
                          alignment: pw.Alignment.center,
                        ),
                      ),
                      pw.Expanded(
                        child: pw.Container(
                          child: pw.Text('${double.parse((totalAmount).toStringAsFixed(2))} TK',style: boldTextStyle.copyWith(color: PdfColors.purple)),
                          padding: const pw.EdgeInsets.all(3),
                          alignment: pw.Alignment.center,
                        ),
                      ),
    ...
    try{
      ...
      final String fileName = 'sales-report-${DateTime.now().millisecondsSinceEpoch}.pdf';
